Это веб приложение написанное на фреймворке Flask, его функционал в следующем: пользователь может регистрироваться/логиниться, предсказать сорт ириса на основе своих данных,
